...
insert into messages(roomID, sender, postTime, text) values(1, 1, 1, (select now()), 'hello');
insert into messages(roomID, sender, postTime, text) values(2, 1, 7, (select now()), 'hi');
